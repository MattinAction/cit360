...
public class Map {
    public static void runMap(){
        ...
        // Nasty Path: Key is null and get(null)
        // Result: Treats null as a legitimate key
        grades.put(null, 17);
        System.out.println("Null Key = " + grades.get(null) + "\n");

        // Nasty Path: Both Key and value are null
        // Result: Runs normally. Null calls the value of null
        grades.put(null, null);
        System.out.println("Null Key and Value = " + grades.get(null) + "\n");
    }
