...
public class List {
    public static void runList(){
        try {
            ...
            // Happy Path: set() method
            // Result: Lee is added to the second position within the list
            list1.set(1, "Lee");
            System.out.println("Demonstrating the set() method");
            System.out.println("\t" + list1 + "\n");

            // Nasty Path: set(negative index value)
            // Result: Out of bounds exception
            list1.set(-2, "Travis");
            System.out.println("Nasty Path: Negative index");
            System.out.println("\t" + list1 + "\n");
